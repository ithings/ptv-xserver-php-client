...
/**
 * DistanceMatrixIdNotFoundFault Class Doc Comment
 *
 * @category Class
 * @package  ithings\ptvxserver
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DistanceMatrixIdNotFoundFault extends InvalidRequestFault 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DistanceMatrixIdNotFoundFault';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['distance_matrix_id'] === null) {
            $invalidProperties[] = "'distance_matrix_id' can't be null";
        }
     ...
     *
     * @param string $distance_matrix_id The distance matrix ID that could not be found.
     *
     * @return $this
     */
