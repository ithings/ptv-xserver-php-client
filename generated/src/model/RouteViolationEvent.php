...
/**
 * RouteViolationEvent Class Doc Comment
 *
 * @category Class
 * @package  ithings\ptvxserver
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RouteViolationEvent extends RouteEvent 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RouteViolationEvent';
    ...
    protected static $swaggerTypes = [
        'violation_type' => '\ithings\ptvxserver\model\RouteViolationType',
'violated_feature' => '\ithings\ptvxserver\model\ViolatedFeature',
...
'violated_feature' => 'violatedFeature',
...
'violated_feature' => 'setViolatedFeature',
...
'violated_feature' => 'getViolatedFeature',
...
'related_event_index' => 'getRelatedEventIndex'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['violation_type'] = isset($data['violation_type']) ? $data['violation_type'] : null;
        $this->container['violated_feature'] = isset($data['violated_feature']) ? $data['violated_feature'] : null;
     ...
     * Gets violation_type
     *
     * @return \ithings\ptvxserver\model\RouteViolationType
     */
     ...
     * Sets violation_type
     *
     * @param \ithings\ptvxserver\model\RouteViolationType $violation_type violation_type
     *
     * @return $this
     */
    ...
    /**
     * Gets violated_feature
     *
     * @return \ithings\ptvxserver\model\ViolatedFeature
     */
    public function getViolatedFeature()
    {
        return $this->container['violated_feature'];
    }

    /**
     * Sets violated_feature
     *
     * @param \ithings\ptvxserver\model\ViolatedFeature $violated_feature violated_feature
     *
     * @return $this
     */
    public function setViolatedFeature($violated_feature)
    {
        $this->container['violated_feature'] = $violated_feature;
