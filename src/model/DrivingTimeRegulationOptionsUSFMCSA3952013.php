...
/**
 * DrivingTimeRegulationOptionsUSFMCSA3952013 Class Doc Comment
 *
 * @category Class
 * @package  ithings\ptvxserver
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DrivingTimeRegulationOptionsUSFMCSA3952013 extends DrivingTimeRegulationOptions 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DrivingTimeRegulationOptions_US_FMCSA_395_2013';
...
'weekly_on_duty_hours_limit' => '\ithings\ptvxserver\model\WeeklyOnDutyHoursLimitUSFMCSA3952013',
...
'thirty_minute_break_rule' => 'getThirtyMinuteBreakRule'    ];
     ...
     *
     * @return \ithings\ptvxserver\model\WeeklyOnDutyHoursLimitUSFMCSA3952013
     */
     ...
     *
     * @param \ithings\ptvxserver\model\WeeklyOnDutyHoursLimitUSFMCSA3952013 $weekly_on_duty_hours_limit weekly_on_duty_hours_limit
     *
     * @return $this
     */
     ...
     *
     * @param bool $thirty_minute_break_rule Tells if the 30-minute break provision is enforced after 8 on-duty consecutive hours (e.g. it is not required to be enforced for short haul operations).
     *
     * @return $this
     */
