...
/**
 * InvalidValueFault Class Doc Comment
 *
 * @category Class
 * @package  ithings\ptvxserver
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InvalidValueFault extends InvalidRequestFault 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InvalidValueFault';
...
'value' => 'getValue'    ];
     ...
     * Sets parameter
     *
     * @param string $parameter An xPath like specification of the parameter that is set to an invalid value.
     *
     * @return $this
     */
