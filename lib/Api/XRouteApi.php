...
class XRouteApi
{
     ...
     *
     * @param  \Swagger\Client\Model\ReachableAreasRequest $body body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ReachableAreasResponse
     */
     ...
     *
     * @param  \Swagger\Client\Model\ReachableAreasRequest $body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ReachableAreasResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function calculateReachableAreasWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\ReachableAreasResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ReachableAreasResponse',
     ...
     *
     * @param  \Swagger\Client\Model\ReachableLocationsRequest $body body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ReachableLocationsResponse
     */
     ...
     *
     * @param  \Swagger\Client\Model\ReachableLocationsRequest $body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ReachableLocationsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function calculateReachableLocationsWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\ReachableLocationsResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ReachableLocationsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Swagger\Client\Model\RouteRequest $body body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Swagger\Client\Model\RouteRequest $body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Swagger\Client\Model\ProfileRequest $body body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ProfileResponse
     */
     ...
     *
     * @param  \Swagger\Client\Model\ProfileRequest $body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ProfileResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProfileWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\ProfileResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ProfileResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
