...
class XMapApi
{
     ...
     * @return \Swagger\Client\Model\MapResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\MapResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function renderMapWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\MapResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\MapResponse',
