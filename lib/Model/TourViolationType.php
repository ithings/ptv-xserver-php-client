...
/**
 * TourViolationType Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TourViolationType
{
    /**
     * Possible values of this enum
     */
    const PLANNING_HORIZON = 'PLANNING_HORIZON';
const OPERATING_INTERVAL = 'OPERATING_INTERVAL';
const TOUR_START_INTERVAL = 'TOUR_START_INTERVAL';
const OPENING_INTERVAL = 'OPENING_INTERVAL';
const MAXIMUM_TRAVEL_TIME_PER_TOUR = 'MAXIMUM_TRAVEL_TIME_PER_TOUR';
const MAXIMUM_DRIVING_TIME_PER_TOUR = 'MAXIMUM_DRIVING_TIME_PER_TOUR';
const REST_POSITION = 'REST_POSITION';
const MAXIMUM_QUANTITY_SCENARIO = 'MAXIMUM_QUANTITY_SCENARIO';
const VEHICLE_EQUIPMENT = 'VEHICLE_EQUIPMENT';
const MAXIMUM_TRAVEL_TIME_PER_DRIVER = 'MAXIMUM_TRAVEL_TIME_PER_DRIVER';
const MAXIMUM_DRIVING_TIME_PER_DRIVER = 'MAXIMUM_DRIVING_TIME_PER_DRIVER';
const TRIP_START_INTERVAL = 'TRIP_START_INTERVAL';
const MAXIMUM_NUMBER_OF_CUSTOMER_STOPS = 'MAXIMUM_NUMBER_OF_CUSTOMER_STOPS';
const CUSTOMER_STOP_POSITION_IN_TRIP = 'CUSTOMER_STOP_POSITION_IN_TRIP';
const TRIP_SECTION = 'TRIP_SECTION';
const MAXIMUM_DISTANCE = 'MAXIMUM_DISTANCE';
const MIXED_LOADING_PROHIBITION = 'MIXED_LOADING_PROHIBITION';
const ROUTE = 'ROUTE';
...
self::TOUR_START_INTERVAL,
self::OPENING_INTERVAL,
self::MAXIMUM_TRAVEL_TIME_PER_TOUR,
self::MAXIMUM_DRIVING_TIME_PER_TOUR,
self::REST_POSITION,
self::MAXIMUM_QUANTITY_SCENARIO,
self::VEHICLE_EQUIPMENT,
self::MAXIMUM_TRAVEL_TIME_PER_DRIVER,
self::MAXIMUM_DRIVING_TIME_PER_DRIVER,
self::TRIP_START_INTERVAL,
self::MAXIMUM_NUMBER_OF_CUSTOMER_STOPS,
self::CUSTOMER_STOP_POSITION_IN_TRIP,
self::TRIP_SECTION,
self::MAXIMUM_DISTANCE,
self::MIXED_LOADING_PROHIBITION,
self::ROUTE,
self::REACHABILITY,
self::UNSPECIFIED,        ];
    }
