...
/**
 * LegResultFields Class Doc Comment
 *
 * @category Class
 * @description Specifies if and to what extent the legs shall be returned for the complete route. Hint: Corresponding type in xServer API documentation - com.ptvgroup.xserver.xroute.LegResultFields
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LegResultFields implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LegResultFields';
...
'emissions' => 'getEmissions'    ];
     ...
     * Sets enabled
     *
     * @param bool $enabled Specifies if the legs shall be returned for the complete route.
     *
     * @return $this
     */
     ...
     * Sets polyline
     *
     * @param bool $polyline Specifies if the legs shall contain the polyline.
     *
     * @return $this
     */
     ...
     * Sets toll_summary
     *
     * @param bool $toll_summary Specifies if the legs shall contain the toll summary.
     *
     * @return $this
     */
     ...
     * Sets emissions
     *
     * @param bool $emissions Specifies if the legs shall contain the emissions.
     *
     * @return $this
     */
