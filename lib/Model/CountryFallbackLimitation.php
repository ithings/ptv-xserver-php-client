...
/**
 * CountryFallbackLimitation Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CountryFallbackLimitation extends ResultLimitation 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CountryFallbackLimitation';
...
'fallback_country_code' => 'getFallbackCountryCode'    ];
     ...
     *
     * @param string $requested_subdivision_code The country subdivision code that was requested in allowedCountries, but cannot be used for filtering.
     *
     * @return $this
     */
