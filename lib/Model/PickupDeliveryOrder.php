...
/**
 * PickupDeliveryOrder Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PickupDeliveryOrder extends TransportOrder 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PickupDeliveryOrder';
...
'delivery_location_id' => 'getDeliveryLocationId'    ];
     ...
     *
     * @param string $pickup_location_id ID of the location where the goods should be picked up. This location is either a customer site or a depot site.
     *
     * @return $this
     */
     ...
     *
     * @param string $delivery_location_id ID of the location where the goods should be delivered to. This location is either a customer site or a depot site.
     *
     * @return $this
     */
